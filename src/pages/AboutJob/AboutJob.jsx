                    ...
                    <div className={styles.aboutPageBottom}>
                        <div className={styles.bottomLeft}>
                            ...
                            <p className={styles.description}>
                                We are seeking an aspiring Backend Developer to
                                join our dynamic team. The successful candidate
                                will work on developing and maintaining
                                high-quality software applications. You will
                                work alongside experienced software engineers to
                                design and implement complex applications, debug
                                and resolve issues.
                            </p>
                            <div className={styles.headline}>About Company</div>
                            <p className={styles.description}>
                                RippleHire exists to make recruiting effortless,
                                human and delightful. RippleHire is a
                                cloud-based hiring platform that was founded
                                with the mission of enabling enterprises hire
                                great talent effortlessly. Our dedication to the
                                craft has seen our customers win several
                                national and international awards. We are known
                                for a category defining employee referral
                                product and a deep talent acquisition platform.
                            </p>
                        </div>
